    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('patient', 'Patient'), ('doctor', 'Doctor'), ('receptionist', 'Receptionist'), ('admin', 'Admin'), ('nurse', 'Nurse'), ('accountant', 'Accountant'), ('lab_tech', 'Lab Tech')], default='patient', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qualificationDoc', models.FileField(blank=True, upload_to=accounts.models.user_directory_path)),
                ('IdProof', models.FileField(blank=True, upload_to=accounts.models.user_directory_path)),
                ('addressProof', models.FileField(blank=True, upload_to=accounts.models.user_directory_path)),
                ('otherDoc', models.FileField(blank=True, upload_to=accounts.models.user_directory_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patients', models.ManyToManyField(related_name='doctors', to='accounts.Patient')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
